    ...
    <div className="w-full max-w-xl mx-auto px-4 py-6 sm:py-10">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-md border border-gray-200 dark:border-slate-800 p-5 sm:p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-sm font-semibold text-gray-900 dark:text-slate-200 mb-1">Correo Electrónico</label>
            <input
              id="login-email"
              aria-label="Email"
              className="w-full border border-gray-300 dark:border-slate-700 rounded-xl px-3.5 py-2.5 text-base bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
              type="email"
              autoComplete="email"
              value={email}
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label htmlFor="login-password" className="block text-sm font-semibold text-gray-900 dark:text-slate-200">Contraseña</label>
          ...
          <div className="text-center text-sm text-gray-600 dark:text-slate-400 pt-3 border-t border-gray-100 dark:border-slate-800 space-y-2">
            <div>
              ¿No tienes cuenta?{' '}
            ...
            <div className="text-[11px] text-gray-700 dark:text-slate-300 bg-gray-50 dark:bg-slate-800/90 p-3 rounded-xl border border-gray-200 dark:border-slate-700 text-left leading-relaxed">
              🔒 <strong className="text-gray-900 dark:text-white">Nota de Seguridad:</strong> Todos los nuevos registros entran en estado <em>Pendiente</em> y deben ser aprobados por el Administrador del club para activar su cuenta.
            </div>
          </div>
        </form>
      </div>

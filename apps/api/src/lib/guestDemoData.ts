...
export const GUEST_EVENTS: any[] = [
  {
    id: 101,
    title: 'Final - Copa Nacional Ultimate 2026',
    type: 'MATCH',
    ...
    status: 'COMPLETED',
    teamId: 1,
    team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
    awayTeamId: 2,
    awayTeam: { id: 2, name: 'Dragones Ultimate Club', color: '#b91c1c', logoUrl: null },
  ...
  {
    id: 102,
    title: 'Entrenamiento Táctico Avanzado (Línea O vs Línea D)',
    type: 'TRAINING',
  ...
  {
    id: 103,
    title: 'Torneo Relámpago - Copa Apertura',
    type: 'TOURNAMENT',
    startsAt: new Date(now.getTime() - 86400000 * 15).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 15 + 28800000).toISOString(),
    ...
    children: [
      {
        id: 1031,
        parentId: 103,
        title: 'Fase de Grupos - Juego 1 (Warao vs Dragones)',
        type: 'MATCH',
        matchCategory: 'GROUP_STAGE',
        startsAt: new Date(now.getTime() - 86400000 * 15 + 3600000).toISOString(),
        endsAt: new Date(now.getTime() - 86400000 * 15 + 7200000).toISOString(),
        location: 'Cancha 1',
        status: 'COMPLETED',
        teamId: 1,
        team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
      ...
      },
      {
        id: 1032,
        parentId: 103,
        title: 'Fase de Grupos - Juego 2 (Warao vs Cóndores)',
        type: 'MATCH',
        matchCategory: 'GROUP_STAGE',
        startsAt: new Date(now.getTime() - 86400000 * 15 + 10800000).toISOString(),
        endsAt: new Date(now.getTime() - 86400000 * 15 + 14400000).toISOString(),
        location: 'Cancha 2',
        status: 'COMPLETED',
        teamId: 1,
        team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
        awayTeamId: 3,
        awayTeam: { id: 3, name: 'Cóndores Voladores', color: '#1d4ed8', logoUrl: null },
        children: []
      },
      {
        id: 1033,
        parentId: 103,
        title: 'Gran Final de Torneo Relámpago',
        type: 'MATCH',
        matchCategory: 'FINALS',
        startsAt: new Date(now.getTime() - 86400000 * 15 + 18000000).toISOString(),
        endsAt: new Date(now.getTime() - 86400000 * 15 + 21600000).toISOString(),
  ...
  {
    id: 104,
    title: 'Full Day Mixto de Integración',
    type: 'FULL_DAY_MIXTO',
    startsAt: new Date(now.getTime() - 86400000 * 8).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 8 + 28800000).toISOString(),
    location: 'Parque Recreacional',
    status: 'COMPLETED',
    teamId: 1,
    team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
    children: [],
  ...
  {
    id: 105,
    title: 'Amistoso Preparatorio vs. Cóndores',
    type: 'AMISTOSO',
    startsAt: new Date(now.getTime() - 86400000 * 20).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 20 + 7200000).toISOString(),
    location: 'Cancha Sur',
    status: 'COMPLETED',
    teamId: 1,
    team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
  ...
  {
    id: 106,
    title: 'Entrenamiento Físico y Pliometría',
    type: 'TRAINING',
    startsAt: new Date(now.getTime() - 86400000 * 22).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 22 + 7200000).toISOString(),
    location: 'Gimnasio del Club',
    status: 'COMPLETED',
    children: [],
    createdAt: new Date('2025-01-08T10:00:00Z')
  },
  {
    id: 107,
    title: 'Reunión de Directiva y Finanzas',
    type: 'SOCIAL',
    startsAt: new Date(now.getTime() - 86400000 * 1).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 1 + 5400000).toISOString(),
  ...
  {
    id: 108,
    title: 'Próximo Partido Oficial - Liga Regional',
    type: 'MATCH',
    startsAt: new Date(now.getTime() + 86400000 * 5).toISOString(),
    endsAt: new Date(now.getTime() + 86400000 * 5 + 7200000).toISOString(),
    location: 'Estadio Este',
    status: 'UPCOMING',
    teamId: 1,
    team: { id: 1, name: 'Warao Ultimate Club', color: '#f59e0b', logoUrl: null },
    awayTeamId: 2,
  ...
  {
    id: 109,
    title: 'Taller de Lanzamientos (Manejadores)',
    type: 'WORKSHOP',
    startsAt: new Date(now.getTime() - 86400000 * 30).toISOString(),
    endsAt: new Date(now.getTime() - 86400000 * 30 + 7200000).toISOString(),
    location: 'Cancha Central',
    status: 'COMPLETED',
    children: [],
    createdAt: new Date('2025-01-08T10:00:00Z')
  ...
  {
    id: 110,
    title: 'Full Day Open Masc & Fem',
    type: 'FULL_DAY_OPEN',
    startsAt: new Date(now.getTime() + 86400000 * 12).toISOString(),
    endsAt: new Date(now.getTime() + 86400000 * 12 + 28800000).toISOString(),

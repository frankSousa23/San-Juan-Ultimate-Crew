 ...
 */
router.post('/', requirePermission('events:manage'), validateBody(createEventSchema), asyncHandler(async (req, res) => {
 ...
 */
router.put('/:id', requirePermission('events:manage'), validateParams(eventIdSchema), validateBody(updateEventSchema), asyncHandler(async (req, res) => {
 ...
 *         description: Event not found
 */
router.delete('/:id', requirePermission('events:manage'), validateParams(eventIdSchema), asyncHandler(async (req, res) => {
    const id = Number(req.params.id);
